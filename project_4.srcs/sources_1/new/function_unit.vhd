...
signal B_vector_in      : vector(H-1 downto 0)(data_width-1 downto 0);
...
assign_coefficient_gen: for I in 0 to H-1 generate
    B_vector(I) <= coefficient_matrix(0)(2) when input(I) < condition_vector(0) else
                   coefficient_matrix(1)(2) when input(I) < condition_vector(1) else
                   coefficient_matrix(2)(2) when input(I) < condition_vector(2) else
                   coefficient_matrix(3)(2) when input(I) < condition_vector(3) else
                   coefficient_matrix(4)(2) when input(I) < condition_vector(4) else
                   coefficient_matrix(5)(2);
    
    C_vector(I) <= coefficient_matrix(0)(1) when input(I) < condition_vector(0) else   
                   coefficient_matrix(1)(1) when input(I) < condition_vector(1) else   
                   coefficient_matrix(2)(1) when input(I) < condition_vector(2) else   
                   coefficient_matrix(3)(1) when input(I) < condition_vector(3) else   
                   coefficient_matrix(4)(1) when input(I) < condition_vector(4) else   
                   coefficient_matrix(5)(1);                                           
                                                                                                      
    D_vector(I) <= coefficient_matrix(0)(0) when input(I) < condition_vector(0) else   
                   coefficient_matrix(1)(0) when input(I) < condition_vector(1) else   
                   coefficient_matrix(2)(0) when input(I) < condition_vector(2) else   
                   coefficient_matrix(3)(0) when input(I) < condition_vector(3) else   
                   coefficient_matrix(4)(0) when input(I) < condition_vector(4) else   
                   coefficient_matrix(5)(0);                                           
    B_vector_in(I) <= B_vector(I) when loop_counter < 4 else S_vector(I)(31 downto 24);
...
assign_output_gen: for I in 0 to H-1 generate
    output(I) <= S_vector(I)(2*data_width - 1 downto 0);
