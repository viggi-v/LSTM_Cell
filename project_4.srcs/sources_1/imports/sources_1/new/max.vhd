...
signal AinR, BinR, CinR: std_logic_vector(data_width - 1 downto 0);   -- Registered Ain and Bin
...
signal  CinR2 : std_logic_vector(2*data_width downto 0) := (others => '0');
constant ZERO : std_logic_vector(2*data_width downto 0) := (others => '0');  -- 48 bit "ZERO" constant used for MULTR sign extension to 48 bits
constant dummy_ZERO : std_logic_vector(data_width downto 0) := (others => '0');
